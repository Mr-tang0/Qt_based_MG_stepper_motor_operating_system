...
struct motorDATA
{
    ...
    //角度环 pid
    QString anglePid = QStringLiteral("96");//6

    //速度环 pid
    QString speedPid = QStringLiteral("97");//6

    //最大速度
    QString maxSpeed = QStringLiteral("9A");//4

    //最大角度低 4 字节
    QString maxAngleLOW = QStringLiteral("9B");//4

    //最大角度高 4 字节
    QString maxAngleHIGH = QStringLiteral("9C");//4

    //速度斜率
    QString speedRamp = QStringLiteral("9E");//4
